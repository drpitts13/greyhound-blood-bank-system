...
| URS-BB-017 / FRS-BB-003 | Manual and ADT merge reassign history to the survivor | `PatientMergeService`; `POST /api/patients/{id}/merge`; ADT A18/A40 | `PatientMergeServiceTests`; Phase 5 HL7 merge tests | I | RISK-BB-015; OCD-010 |
