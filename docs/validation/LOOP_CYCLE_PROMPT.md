...
- OCD-004 / gap 2 — Licensed ICCBBA / ISBT tables (admin import dialog exists; do not invent codes; ask before claiming a licensed extract is loaded)
- OCD-001 / gap 17 — Electronic XM after a currently undetectable antibody (`XM-EC-HISTORY` still blocks)
