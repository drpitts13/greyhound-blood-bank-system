...
accepted transport-trust (OCD-034).
...
| 9 | P5 | Configuration effective-dating incomplete (`FRS-BB-070`) | Medium (OCD-033) | SME; do not invent as-of dates |
...
| 18 | P6 | Broader CSRF / XSS / secrets review | Medium | Identity was the larger hole |
