...
| URS-BB-010 | Inventory states and modifications remain historically traceable. | P3 | FRS-BB-050, FRS-BB-175, FRS-BB-176, FRS-BB-178, FRS-BB-179, FRS-BB-180 |
...
| URS-BB-060 | Placing a unit in quarantine or on hold, or marking it missing or damaged, is limited to staff with inventory.release. | P3 | FRS-BB-094, FRS-BB-180 |
...
| URS-BB-146 | Staff can find a manual place-into-quarantine or place-on-hold as ProductStatus on the unit id with old/new status, because those units must not later issue until released. Mark-missing, mark-damaged, locate, and inspect stay interceptor Update. | P0 | FRS-BB-180 |
