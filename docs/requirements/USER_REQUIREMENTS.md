...
| URS-BB-047 | Staff can distinguish manual, instrument, interface, and calculated result sources, and instrument/interface values wait for verification. | P3 | FRS-BB-079, FRS-BB-089, FRS-BB-124, FRS-BB-163, FRS-BB-167, FRS-BB-177, FRS-BB-189, FRS-BB-192 |
...
| URS-BB-009 | Electronic (computer) XM is available only when configured prerequisites hold. | P0 | FRS-BB-033, FRS-BB-169, FRS-BB-193 |
| URS-BB-010 | Inventory states and modifications remain historically traceable. | P3 | FRS-BB-050, FRS-BB-175, FRS-BB-176, FRS-BB-178, FRS-BB-179, FRS-BB-180, FRS-BB-181, FRS-BB-182, FRS-BB-183, FRS-BB-184, FRS-BB-185 |
| URS-BB-011 | Clinical and configuration changes are auditable (who/what/when/where/old/new/why). | P4 | FRS-BB-060, FRS-BB-078, FRS-BB-085, FRS-BB-087, FRS-BB-089, FRS-BB-093, FRS-BB-095, FRS-BB-104, FRS-BB-106, FRS-BB-109, FRS-BB-111, FRS-BB-114, FRS-BB-116, FRS-BB-119, FRS-BB-121, FRS-BB-126, FRS-BB-129, FRS-BB-131, FRS-BB-148, FRS-BB-150, FRS-BB-152, FRS-BB-153, FRS-BB-154, FRS-BB-155, FRS-BB-156, FRS-BB-157, FRS-BB-158, FRS-BB-159, FRS-BB-160, FRS-BB-161, FRS-BB-162, FRS-BB-164, FRS-BB-165, FRS-BB-166, FRS-BB-168, FRS-BB-170, FRS-BB-172, FRS-BB-173, FRS-BB-174, FRS-BB-175, FRS-BB-176, FRS-BB-177, FRS-BB-178, FRS-BB-179, FRS-BB-180, FRS-BB-181, FRS-BB-182, FRS-BB-183, FRS-BB-184, FRS-BB-185, FRS-BB-186, FRS-BB-187, FRS-BB-188, FRS-BB-189 |
...
| URS-BB-033 | Correcting a unit DIN, product code, ABO/Rh code, or related ISBT identity field is limited to staff with inventory.correct-identity. | P1 | FRS-BB-063, FRS-BB-187 |
| URS-BB-034 | Releasing a reserved unit back to Available is limited to staff with compatibility.allocate. | P0 | FRS-BB-064 |
| URS-BB-035 | Receiving an ISBT unit by scan-session complete or manual entry is limited to staff with inventory.receive. | P0 | FRS-BB-065, FRS-BB-175 |
...
| URS-BB-037 | Receiving a unit by walk-in, expected-arrival confirmation, or normalized component intake is limited to staff with inventory.receive. | P0 | FRS-BB-067, FRS-BB-175, FRS-BB-176 |
...
| URS-BB-042 | Transferring a unit between storage locations is limited to staff with inventory.transfer. | P1 | FRS-BB-073, FRS-BB-184 |
| URS-BB-043 | Recalling a unit from inventory (not via lookback DIN recall) is limited to staff with inventory.recall. | P0 | FRS-BB-074, FRS-BB-179 |
...
| URS-BB-048 | Returning a unit to the supplier is limited to staff with inventory.receive. | P3 | FRS-BB-081, FRS-BB-183 |
...
| URS-BB-050 | Locating a missing unit or inspecting a damaged unit into quality quarantine is limited to staff with inventory.release. | P3 | FRS-BB-083, FRS-BB-182 |
| URS-BB-051 | Recording or cancelling an expected inbound packing-list unit is limited to staff with inventory.receive. | P3 | FRS-BB-084, FRS-BB-176 |
...
| URS-BB-063 | Staff can record antibody-identification panel reactions, review assistance, interpret, and obtain supervisor review before identified antibodies post to history. Assistance must not silently replace technologist judgment. | P0 | FRS-BB-097, FRS-BB-168, FRS-BB-171, FRS-BB-188 |
...
| URS-BB-090 | Staff can see the current result source on the test worklist and the patient Tests tab, including instrument values waiting for verification. | P3 | FRS-BB-124, FRS-BB-163, FRS-BB-167, FRS-BB-192 |
...
| URS-BB-134 | Staff can find antibody-identification workup open, link, lot-attach, assist, interpret, void, and stale-panel as Antibody, not mixed with test Result entry. Supervisor accept and complete stay Verify. Posted Identified findings stay Antibody on history. | P0 | FRS-BB-168, FRS-BB-188 |
...
| URS-BB-144 | Staff can find quarantine release and operational-hold release as ProductStatus on the unit id with old/new status, because those actions make a unit Available for later issue. Placing into quarantine or hold is `FRS-BB-180`. | P0 | FRS-BB-178 |
| URS-BB-145 | Staff can find a direct inventory recall as ProductStatus on the unit id with old/new status, because that unit must not later issue. Lookback DIN recall stays Lookback. | P0 | FRS-BB-179 |
| URS-BB-146 | Staff can find a manual place-into-quarantine or place-on-hold as ProductStatus on the unit id with old/new status, because those units must not later issue until released. Mark-missing and mark-damaged are `FRS-BB-181`. Locate and inspect are `FRS-BB-182`. | P0 | FRS-BB-180 |
| URS-BB-147 | Staff can find mark-missing and mark-damaged as ProductStatus on the unit id with old/new status, because those units must not later issue. Locate-after-missing and inspect-after-damage are `FRS-BB-182`. | P0 | FRS-BB-181 |
| URS-BB-148 | Staff can find locate-after-missing and inspect-after-damage as ProductStatus on the unit id with old/new status, because those units re-enter quarantine and must not later issue until released. | P0 | FRS-BB-182 |
| URS-BB-149 | Staff can find a return to supplier as ProductStatus on the unit id with old/new status, because that unit is terminal and must not later issue. Ward return and cancel-expected stay their existing named events. | P0 | FRS-BB-183 |
| URS-BB-150 | Staff can find a location transfer as ProductStatus on the unit id with old/new location, because later issue and lookback follow the last storage location. Status is unchanged. | P1 | FRS-BB-184 |
| URS-BB-151 | Staff can find each unit moved by the expiration sweep as ProductStatus on the unit id with old/new status, because those units must not later issue. The sweep does not discard. | P0 | FRS-BB-185 |
| URS-BB-152 | Staff can see on `/audit` the interpreted ABO/Rh of a unit retype on enter, update, and verify, because that type is used at later compatibility and issue. Stored type is not changed by the audit payload. | P0 | FRS-BB-186 |
...
| URS-BB-157 | Staff can see the crossmatch method and Compatible or Incompatible result after recording a crossmatch, not only the row id. | P3 | FRS-BB-191 |
