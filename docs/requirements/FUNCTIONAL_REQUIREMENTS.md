...
| FRS-BB-003 | Merged patient records HardStop accession, orders, result entry/verify/correct, immunohematology writes, special requirements, issue, allocation, compatibility evaluation, and crossmatch (`PAT-MERGED-INACTIVE`). Inactive status is not blocked. | URS-BB-015 | `PatientMergeRule.EvaluateClinicalUse`; `IssueGate`; Specimen/Order/Result/Immuno/SpecialRequirement services | `MergedPatientClinicalUseTests` |
