...
| SRS-BB-009 | A merged (losing) patient is rejected at each clinical write path (accession, order, result entry/verify/correct, immunohematology, special requirements, allocate, XM, issue), not only at issue. | FRS-BB-003 |
