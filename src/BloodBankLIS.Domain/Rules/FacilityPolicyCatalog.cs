...
public static class FacilityPolicyCatalog
{
    ...
    [
        ...
        new(FacilityPolicyKeys.RequireSecondVerifier, "Transfusion", "Require second verifier at issue",
            "Optional. When true, issue requires a distinct second verifier or validated electronic identification. Small labs may leave this off.",
            FacilityPolicyValueKind.Boolean, "true", "AABB 5.11 / 5.28 / OCD-008"),
        ...
        new(FacilityPolicyKeys.AllowElectronicCrossmatch, "Issue", "Allow electronic crossmatch",
            "Off by default. Enable in Facility Policy after the facility validates AABB 5.16 computer XM. Disabled policy is a HardStop (XM-EC-POLICY).",
            FacilityPolicyValueKind.Boolean, "false", "AABB 5.16 / CAP TRM.40650 / OCD-006"),
        ...
        new(FacilityPolicyKeys.RequireQuarantineReleaseVerifier, "Inventory", "Quarantine-release verifier",
            "Optional. When true, quality-quarantine release requires a distinct directory user.",
            FacilityPolicyValueKind.Boolean, "true", "21 CFR 606.100 / AABB 5.1.5 / OCD-008"),
        ...
        new(FacilityPolicyKeys.RequireReceiveVerifier, "Inventory", "Receive second verifier",
            "Optional. When true, receiving a unit requires a distinct directory user. Small labs may leave this off.",
            FacilityPolicyValueKind.Boolean, "true", "AABB 5.6 / 21 CFR 606.160 / OCD-008"),
        ...
        new(FacilityPolicyKeys.RequireDiscardVerifier, "Inventory", "Discard second verifier",
            "Optional. When true, discard requires a distinct directory user.",
            FacilityPolicyValueKind.Boolean, "true", "21 CFR 606.160 / AABB 5.1.5 / OCD-008"),
        new(FacilityPolicyKeys.RequireDirectedConversionVerifier, "Inventory", "Directed-conversion verifier",
            "Optional. When true, directed-to-allogeneic conversion requires a distinct directory user.",
            FacilityPolicyValueKind.Boolean, "true", "AABB 5.4 / 21 CFR 606.160 / OCD-008"),
