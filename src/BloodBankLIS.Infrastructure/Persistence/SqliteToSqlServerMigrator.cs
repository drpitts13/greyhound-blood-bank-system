...
public sealed class SqliteToSqlServerMigrator
{
    ...
    [
        ...
        "CompatibilityRules",
        "BloodProducts",
        "ProductRetypeResults",
        "UnitModificationUnits",
        ...
        "AntibodyPanelLots",
        "AntibodyPanelCells",
        "AntibodyPanelCellAntigens",
        "AntibodyIdentificationWorkups",
        "AntibodyIdentificationWorkupLots",
        "AntibodyIdentificationReactions",
        "AntibodyIdentificationFindings",
        "UnitBloodAttributes",
