...
{
    /// <inheritdoc />
    public partial class SpecimenTypeDefinitions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "SpecimenTypeDefinitions",
                columns: table => new
                {
                    ...
                    ExcludedTestCodesJson = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecimenTypeDefinitions", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_SpecimenTypeDefinitions_Code",
